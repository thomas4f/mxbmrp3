...
copy that cannot drift from what is actually emitted. `tools/hud_window/README.md`
covers the reader's side: decompression, caching, and why the atlas cell height
makes the on-screen metrics exact.
