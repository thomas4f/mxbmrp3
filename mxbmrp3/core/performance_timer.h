// ============================================================================
// core/performance_timer.h
// High-resolution performance timing utilities for the callback-tape recorder.
// Header-only; Win32 QueryPerformanceCounter with a 1MHz fallback.
// ============================================================================
#pragma once
